...
def dragon()
  ...
  puts "The door quickly closes behind you. You realize you cannot leave, you must fight the dragon"
  puts "The dragon has 420 health and has great claws"
...
def shop()
  ...
  products = ["small_health_potion", "medium_health_potion", "large_health_potion", "small_damage_potion", "medium_damage_potion", "large_damage_potion", "fur_hat", "chainmail_armour"]
