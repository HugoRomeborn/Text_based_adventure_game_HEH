...
class Player 
  ...
  def meele_attack(enemy)
    ...
    puts "Choose your weapon from your inventory: #{weapon}"
    input = gets.chomp.downcase.to_s
...
def room_to_the_north()
  ...
  puts "Options: room_to_the_west, room_to_the_east, room_to_the_south, entrance"
  next_room = gets.chomp.downcase
  until ["room_to_the_west", "room_to_the_east", "room_to_the_south", "entrance"].include?(next_room)
    puts "Invalid choice. Please enter: room_to_the_west, room_to_the_east, room_to_the_south, or entrance"
    next_room = gets.chomp.downcase
  end
  return next_room
end
...
def room_to_the_south()
  ...
  while gustaf.health>0 && $player1.health>0
    ...
    puts "chosse attack meele or potion"
    ...
    if attack == "meele"
      ...
      $player1.melee_attack(weapon, gustaf)
